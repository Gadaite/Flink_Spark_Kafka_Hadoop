 ...
 * 使用Spark方式连接数据，获取数据集
 */
public class PostgresqlJdbcCon extends BaseSparkENV implements Serializable  {
    Properties properties = new Properties();
    public PostgresqlJdbcCon() {
    }
    ...
    public PostgresqlJdbcCon(Properties properties) {
     ...
     * @throws Exception
     */
    public void PushToPSql(Dataset dataset,String tableName,String SaveMode) throws Exception {
