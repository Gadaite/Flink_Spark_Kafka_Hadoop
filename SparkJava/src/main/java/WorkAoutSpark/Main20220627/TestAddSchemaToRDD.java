...
import GadaiteToolConnectDB.PostgresSqlRowInsert;
...
public class TestAddSchemaToRDD {
    public static void main(String[] args) throws Exception {
         ...
         * 测试数据入库,测试先前自定义的工具类
         */
        new PostgresSqlRowInsert().ExecInsertRow(ContainSchemeRDD,"test20220627");

        PostgresqlConnect pSqlConnect = new PostgresqlConnect();
        ContainSchemeRDD.foreach(new PostgresSqlRowInsert(pSqlConnect,"test20220627"));
    }
}
